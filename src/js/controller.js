...
const App = (function () {
  ...
  const loadRecipe = async function () {
    ...
    try {
      ...
      const res = await fetch(
        `https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bca3b?key=c839caa0-136c-4f5b-881a-530fef098fe9`
      );
  ...
  return { recipeContainer, loadRecipe, showRecipe, timeout };
})();
